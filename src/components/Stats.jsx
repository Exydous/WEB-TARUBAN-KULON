...
const accents = ['border-l-orange-600', 'border-l-orange-400', 'border-l-wood-400'];
    ...
    <section id="demografi" className="py-16 md:py-24 bg-warm-100">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-md mb-10">
          <p className="text-xs text-orange-600 font-medium uppercase tracking-widest mb-2">
            Data Kependudukan
          </p>
          ...
          {loading
            ...
            : stats.map((stat, i) => (
                ...
                >
                  ...
                  <div className="text-3xl font-semibold text-orange-800 tabular-nums">

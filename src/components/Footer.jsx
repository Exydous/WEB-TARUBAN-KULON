...
// Menambahkan garis miring (/) di depan setiap tautan dan menyesuaikan 'Beranda' menjadi '/'
const footerNav = [
  { label: 'Beranda', href: '/' },
  ...
  { label: 'Galeri', href: '/galeri' }, // Tambahan menu galeri agar seragam
];
...
export default function Footer() {
  ...
  return (
    <footer id="kontak" className="bg-orange-950 text-white">
      {/* ── Main content ── */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          {/* ── Column 2 : Navigation ── */}
          <div>
            <h3 className="text-xs font-semibold text-orange-400 uppercase tracking-widest mb-5">
              Navigasi
            </h3>
            <ul className="space-y-3 mb-10">
              {footerNav.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-orange-200/60 hover:text-white text-sm transition-colors duration-200"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-5">
              {/* Address */}
              <li className="flex items-start gap-3 text-sm text-orange-200/60">
                <svg
